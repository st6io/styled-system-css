...
export var css = function css(args) {
  return function (props) {
    ...
    var _ref = typeof args === 'function' ? args(theme) : args,
        responsiveInput = _ref.responsive,
        obj = _objectWithoutPropertiesLoose(_ref, ["responsive"]);

    var responsiveFactory = responsiveInput || responsive;
    var styles = responsiveFactory(obj)(theme);
    ...
    for (var key in styles) {
      ...
      if (key === 'variant') {
        var variant = css(_extends({
          responsive: responsiveFactory
        }, get(theme, val)))(theme);
